    ...
    <div className="p-6 flex flex-col h-[calc(100vh-var(--header-height,64px))]">
      ...
      <div className="flex items-center gap-2 mb-3 flex-wrap">
        {!streaming ? (
          ...
          <button
            onClick={stop}
            className="flex items-center gap-1.5 px-3 py-1.5 text-sm bg-danger/15 text-danger rounded hover:brightness-110"
          >
      ...
      {/* Error */}
      {error && (
        <div className="mb-3 bg-danger/10 border border-danger/30 rounded px-3 py-2 text-sm text-danger">
          {error}
        </div>
      )}
