...
import (
	...
	"github.com/Liafanx/mtproxyl-panel/internal/sysutil"
)
...
func ExtractBinary(tarGzPath, destPath string) error {
	...
	for {
		...
		// (sudoers expects e.g. staging/mtproxyl-panel, not a random temp name)
...
// matches the sudoers rule (e.g. staging/mtproxyl-panel instead of staging/mtproxyl-panel.bak).
